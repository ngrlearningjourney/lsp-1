...
<div class="mt-3">
    <form action="{{ route('store.transaksi') }}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="tanggal_peminjaman" readonly class="form-control-plaintext" id="staticEmail" value="{{ $tanggal_peminjaman }}">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="staticEmail" class="col-sm-2 col-form-label">Tanggal Wajib Pengembalian:</label>
            <div class="col-sm-10">
                <input type="text" name="tanggal_pengembalian" readonly class="form-control-plaintext" id="staticEmail" value="{{ $tanggal_pengembalian }}">
            </div>
        </div>
        <div class="mt-3">
            <div class="title">
        ...
        <div class="form-floating mt-3">
            <textarea class="form-control" name="deskripsi_transaksi" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
    ...
    <script>
        $(document).ready(function(){
            $('#tabel_buku').DataTable({
                ...
                serverSide:true,
                ajax:{
                url:"{{ route('fetch.transaksi.buku') }}"
                },
                columns:[
                {
                    data:'nama_buku',
